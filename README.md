...
opens a different line of inquiry into what a transformer picks up from next-move prediction alone.
Because a capable model at this scale stays small enough to train on a single GPU, it makes a
convenient toy system for probing interpretability and scaling laws against clean ground truth.
